...
public class Shopping extends AppCompatActivity {
    ...
    public GridViewSuggestShopping suggestAdapter;
    public GridView gridViewAnswer,gridViewSuggest;
    public ImageView imgViewQuestion;
    Button ok;
    int[] image_list={R.drawable.nike,R.drawable.adidas,R.drawable.khaadi,R.drawable.levis,R.drawable.amazon,R.drawable.michaelkors,R.drawable.chanel,R.drawable.gucci};
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)){
                    ...
                    GridViewSuggestShopping suggestAdapter=new GridViewSuggestShopping(suggestSource,getApplicationContext(),Shopping.this);
    ...
    private void setupList() {
        ...
        suggestAdapter=new GridViewSuggestShopping(suggestSource,this,Shopping.this);
