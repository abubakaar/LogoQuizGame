...
import com.example.user.logoquizgame.Adapter.GridViewSuggestCar;
...
public class Car extends AppCompatActivity {
    ...
    public GridViewSuggestCar suggestAdapter;
    public GridView gridViewAnswer,gridViewSuggest;
    public ImageView imgViewQuestion;
    Button ok;

    int[] image_list={R.drawable.careem,R.drawable.toyota,R.drawable.mazda,R.drawable.suzuki,R.drawable.audi,R.drawable.jaguar,R.drawable.ferrari,R.drawable.mitsubishi};
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)){
                    ...
                    GridViewSuggestCar suggestAdapter=new GridViewSuggestCar(suggestSource,getApplicationContext(),Car.this);
    ...
    private void setupList() {
        ...
        suggestAdapter=new GridViewSuggestCar(suggestSource,this,Car.this);
